...
public class WorldGenAzure extends WorldGenerator {
	private int clayBlockId = Block.azure.blockID;
	private int numberOfBlocks;

	public WorldGenAzure(int var1) {
					...
					for(int var33 = (int)(var22 - var30 / 2.0D); var33 <= (int)(var22 + var30 / 2.0D); ++var33) {
						for(int var34 = (int)(var24 - var28 / 2.0D); var34 <= (int)(var24 + var28 / 2.0D); ++var34) {
							...
							if(var35 * var35 + var37 * var37 + var39 * var39 < 1.0D) {
								if(var1.getBlockId(var32, var33, var34) == Block.sand.blockID) {
									var1.setBlock(var32, var33, var34, var2.nextInt(5) == 0? Block.aquamarineOre.blockID : this.clayBlockId);
								}
							}
						}
					}
