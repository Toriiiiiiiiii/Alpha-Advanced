...
// Ripped from a1.2.0 source code.
// Annoyingly obfuscated, I have no idea what's going on here.
//  - Tori
public class ScreenShotHelper {
   ...
   public static String takeScreenshot(File var0, int var1, int var2) {
      try {
         ...
         field_4286_b.clear();
         GL11.glReadPixels(0, 0, var1, var2, GL11.GL_RGB, GL11.GL_UNSIGNED_BYTE, field_4286_b);
         field_4286_b.clear();
